...
var qsParser = function (obj, options) {
...
Kona = {};
Kona.hostUrl = "localhost:3000";
Kona.routes = [];

Kona.addRoute = function (name) {
	Kona.routes.push(name);	

	//add functions
	var capName = capitalizeFirstLetter(name);

	kona[capName] = {};
	kona[capName].route = name;
	kona[capName].find = function (qsObj, success, error) {

		var url = Kona.hostUrl + "/" + this.route + "?" + qsParser(qsObj);
